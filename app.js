...
const cdnItems = [
	...
	[`img/network-mainnet/site.webmanifest`, `application/manifest+json`, "utf8"],
	[`img/network-mainnet/safari-pinned-tab.svg`, `image/svg+xml`, "utf8"],
	[`img/brand/spacexpanse-rod-icon.svg`, `image/svg+xml`, "utf8"],
	[`img/brand/spacexpanse-rod-icon.png`, `image/png`, "binary"],
	[`img/rod-social-preview.svg`, `image/svg+xml`, "utf8"],
	[`img/rod-social-preview.png`, `image/png`, "binary"],
