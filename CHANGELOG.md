...
* **ROD Favicon and Branding Correction**: Fixed explorer favicon and metadata branding so visible browser/app icon surfaces no longer show a Bitcoin badge for the ROD explorer.
  ...
  * Rebuilt main visible favicon/app-icon assets from the ROD brand icon in [`public/img/network-mainnet/favicon-16x16.png`](public/img/network-mainnet/favicon-16x16.png), [`public/img/network-mainnet/favicon-32x32.png`](public/img/network-mainnet/favicon-32x32.png), [`public/img/network-mainnet/apple-touch-icon.png`](public/img/network-mainnet/apple-touch-icon.png), [`public/img/network-mainnet/android-chrome-192x192.png`](public/img/network-mainnet/android-chrome-192x192.png), [`public/img/network-mainnet/android-chrome-512x512.png`](public/img/network-mainnet/android-chrome-512x512.png), [`public/img/network-mainnet/mstile-150x150.png`](public/img/network-mainnet/mstile-150x150.png), [`public/img/network-mainnet/favicon.ico`](public/img/network-mainnet/favicon.ico), and [`public/favicon.ico`](public/favicon.ico).
  * Expanded branding regression coverage in [`test/rod-brand-assets.test.js`](test/rod-brand-assets.test.js); recorded validation from the completed code subtask: [`npx mocha test/rod-brand-assets.test.js`](test/rod-brand-assets.test.js) passed, while [`npm run lint`](package.json:15) remains blocked by ESLint 9 flat-config expectations versus legacy [`.eslintrc.js`](.eslintrc.js).
